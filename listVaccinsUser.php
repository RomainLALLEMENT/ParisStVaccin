...
<?php
		if($carnet){	?>
			<a href="add_vaccin_user.php">Ajouter</a><?php
            // vU = Vaccin user
          ...
          <div class="block">
              <div class="info_vaccin">
                  <div class="vaccin">
                      <div class="html">
                          <div>Nom du vaccin</div>
                          <div> Date de dernière injection</div>
                      </div>
                      <div class="php">
                  ...
                  <div class="boutton"><a href="modificationVaccinUser.php?id=<?= $vU['idVaccin'] ?>" >M</a></div>
              </div>
              <div class="<?= $couleur ?>">
